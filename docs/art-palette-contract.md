...
Из утверждённых мастеров выделены пять 16:9-кандидатов. Все пять QHD-экспортов
сохранены вручную и проверяются без повторного кодирования. Полный контракт
приведён в <a href="wallpaper-contract.md">документации обоев</a>.
